...
const Venues: React.FC = () => {
        ...
        return (
            <div className="flex items-center gap-0.5">
                {Array.from({ length: fullStars }).map((_, i) => (
                    <Star key={`full-${i}`} className="w-4 h-4 fill-primary-500 text-primary-500" />
                ))}
                {hasHalfStar && <Star className="w-4 h-4 fill-primary-500/50 text-primary-500" />}
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-primary-50/20">
            {/* Современный заголовок с градиентом основного цвета */}
            <div className="bg-gradient-to-r from-primary-600 via-primary-500 to-primary-400 shadow-xl shadow-primary/20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <button 
                            className="inline-flex items-center px-6 py-3 bg-white hover:bg-primary-50 text-primary-600 font-bold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="relative mb-8">
                    ...
                    <input
                        ...
                        className="w-full pl-14 pr-6 py-4 bg-white border-2 border-slate-200 rounded-2xl focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 outline-none transition-all text-base shadow-sm hover:shadow-md"
                    />
                </div>
                            ...
                            <>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {paginatedVenues.map((venue) => (
                                        <div
                                            key={venue.id}
                                            className="group bg-white rounded-2xl shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden border border-slate-200/60 hover:border-primary-300 transform hover:-translate-y-1"
                                        >
                                            ...
                                            <div className="flex flex-col sm:flex-row">
                                                ...
                                                <div className="flex-1 p-5 flex flex-col">
                                                    ...
                                                    <div className="flex items-start justify-between mb-3">
                                                        <h3 className="text-lg font-bold text-slate-900 line-clamp-1 group-hover:text-primary-600 transition-colors" title={venue.name}>
                                                            {venue.name}
                                                        </h3>
                                                        <button 
                                                    ...
                                                    <div className="flex items-center gap-2 mt-4 pt-4 border-t border-slate-100">
                                                        <button
                                                            className="flex-1 inline-flex items-center justify-center px-4 py-2.5 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white text-sm font-semibold rounded-xl transition-all shadow-md hover:shadow-lg"
                                    ...
                                    <tr key={staffMember.id} className={`hover:bg-orange-50/50 transition-colors ${index % 2 === 0 ? 'bg-white' : 'bg-slate-50/30'}`}>
                                        <td className="px-6 py-4">
                                            <div className="flex items-center">
                                                <div className="w-12 h-12 bg-gradient-to-br from-primary-400 to-primary-600 rounded-full flex items-center justify-center mr-4 flex-shrink-0 shadow-md">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold bg-gradient-to-r from-primary-100 to-primary-200 text-primary-800">
                                                Admin
                                            </span>
                                        </td>
                                        <td className="px-6 py-4">
